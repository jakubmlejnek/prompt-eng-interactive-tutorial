...
Note: This tutorial uses our smallest, fastest, and cheapest model, Claude Haiku 4.5. Anthropic has [more capable models](https://docs.anthropic.com/en/docs/about-claude/models/overview), such as Claude Sonnet 4.6 and Claude Opus 4.8, which are more intelligent than Haiku, with Opus being the most intelligent.
